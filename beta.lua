...
loadstring(game:HttpGet(id == 1008451066 and "https://api.luarmor.net/files/v3/loaders/c58d9d41abab684038043328ee801418.lua" or "https://api.luarmor.net/files/v3/loaders/5c67cd08a8565b5aee8af935821fdddf.lua"))()
